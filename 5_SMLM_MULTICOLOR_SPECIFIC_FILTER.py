...
def plot_3d_scatter_from_csv(file1_path, file2_path=None, output_directory=None,
    ...
    base_input_directory = '/Users/base/input/directory'
    ...
    x1 = x1[combined_mask] - (roi_center_x - roi_diameter/2)
    y1 = y1[combined_mask] - (roi_center_y - roi_diameter/2)
    z1 = z1[combined_mask]
    ...
    x2 = x2[combined_mask] - (roi_center_x - roi_diameter/2)
    y2 = y2[combined_mask] - (roi_center_y - roi_diameter/2)
    z2 = z2[combined_mask]
...
plot_3d_scatter_from_csv(file1_path, file2_path=file2_path, output_directory=output_directory,
                         sphere_radius=sphere_radius2, filter_radius1=filtering_radius_1, min_neighbors1=filtering_min_neighbours_1,
                         filter_radius2=filtering_radius_2, min_neighbors2=filtering_min_neighbours_2)